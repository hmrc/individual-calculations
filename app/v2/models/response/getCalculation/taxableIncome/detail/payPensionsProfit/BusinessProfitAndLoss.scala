...
import v2.models.response.getCalculation.taxableIncome.detail.payPensionsProfit.eeaPropertyFhl.EeaPropertyFhl
import v2.models.response.getCalculation.taxableIncome.detail.payPensionsProfit.foreignProperty.ForeignProperty
import v2.models.response.getCalculation.taxableIncome.detail.payPensionsProfit.selfEmployment.SelfEmployment
import v2.models.response.getCalculation.taxableIncome.detail.payPensionsProfit.ukPropertyFhl.UkPropertyFhl
import v2.models.response.getCalculation.taxableIncome.detail.payPensionsProfit.ukPropertyNonFhl.UkPropertyNonFhl

...
case class EoyEstimateUkPropertyNonFhl(
...
object EoyEstimateUkPropertyNonFhl {
  ...
  implicit def gqlType: ObjectType[Unit, EoyEstimateUkPropertyNonFhl] = deriveObjectType[Unit, EoyEstimateUkPropertyNonFhl]()
}

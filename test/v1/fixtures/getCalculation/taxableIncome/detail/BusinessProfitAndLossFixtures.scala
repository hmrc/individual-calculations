...
import v1.models.response.getCalculation.taxableIncome.detail.selfEmployment.detail.BusinessSourceAdjustableSummary
...
object BusinessProfitAndLossFixtures {
  ...
  val ukPropertyNonFhlWithoutLossClaimsDetailObject = Some(UkPropertyNonFhl(Some(1000.00),Some(1000.00),Some(1000.00),Some(1000.00),Some(1000.00),
    Some(1000.00),Some(1000.00),None,Some(1000),Some(1000),Some(NonFhlLossClaimsSummary(Some(1000),Some(1000),Some(100),Some(100), Some(1000))),None, None))

  val ukPropertyNonFhlObject = Some(UkPropertyNonFhl(Some(1000.00),Some(1000.00),Some(1000.00),Some(1000.00),Some(1000.00),
    Some(1000.00),Some(1000.00),None,Some(1000),Some(1000),Some(NonFhlLossClaimsSummary(Some(1000),Some(1000),Some(1000), Some(100), Some(1000))),
  ...
  def resultOfClaimsDesJson(incomeSourceType: String) : JsValue = Json.parse(
    ...
    def businessProfitAndLossDesJson(incomeSourceType: String): JsValue = Json.parse(
      s"""
         ...
         |                "broughtForwardCarrySidewaysIncomeTaxLossesUsed": 1000.00
         |            }
    """.stripMargin)

...
object AllowancesDeductionsAndReliefsFixtures {
  ...
  val calculationDetail = CalculationDetail(
    Some(AllowancesAndDeductions(Some(1000), Some(1000), Some(1000), Some(1000), Some(1000), Some(1000),
      Some(1000), Some(1000), Some(AnnualPayments(Some(1000), Some(1000), Some(1000))),
    Some(PensionContributions(Some(1000), Some(1000), Some(1000), Some(1000))))),
    Some(Reliefs(Some(ResidentialFinanceCosts(1000.25, Some(1000.25), 2, 1000.25)), Some(ForeignTaxCreditRelief(
      Some(1000), Some(1000), Some(1000), Some(1000), Some(1000), Some(1000))), Some(PensionContributionReliefs(
      Some(1000), Some(1000), Some(1000))), Some(ReliefsClaimed(Some(1000), Some(1000), Some(1000), Some(1000),
      Some(1000))))))

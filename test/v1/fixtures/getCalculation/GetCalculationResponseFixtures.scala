...
import v1.models.response.getCalculation.allowancesAndDeductions.detail.{AllowancesAndDeductions, AnnualPayments, PensionContributionReliefs, PensionContributions, Reliefs, ReliefsClaimed, CalculationDetail => ADRCalculationDetail}

...
class UkPropertyFhlSpec extends UnitSpec {
  ...
  val fhlResponse = UkPropertyFhl("value")
  ...
  "UkPropertyFhl" when {
    "read from valid Json" should {
      ...
      "with the expected UkPropertyFhl object" in{
        desJson.as[UkPropertyFhl] shouldBe fhlResponse
      }
    }
    ...
    "written to Json" should {
      "return the expected JsObject" in {
        Json.toJson(fhlResponse) shouldBe desJson
      }
    }
  }

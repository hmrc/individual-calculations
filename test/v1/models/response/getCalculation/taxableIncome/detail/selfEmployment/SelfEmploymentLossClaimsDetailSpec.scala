  ...
  "SelfEmploymentLossClaimsDetail" when {
    "read from valid JSON" should {
      "produce the expected SelfEmploymentLossClaimsDetail object" in {
        TaxableIncomeJsonFixture.oneSelfEmploymentDesJson.as[SelfEmploymentLossClaimsDetail] shouldBe
    ...
    "read from non-empty JSON without incomeSourceType '01'" should {
      "produce the expected SelfEmploymentLossClaimsDetail object" in {
        TaxableIncomeJsonFixture.noSelfEmploymentsDesJson.as[SelfEmploymentLossClaimsDetail] shouldBe

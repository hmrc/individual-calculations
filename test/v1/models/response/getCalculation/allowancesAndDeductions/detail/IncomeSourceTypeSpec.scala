...
import v1.models.response.getCalculation.allowancesAndDeductions.detail.IncomeSourceType.{dividendsFromForeignCompanies, fhlPropertyEea, foreignIncome, foreignInterest, foreignProperty}

...
package v1r2.fixtures.getCalculation
...
import v1r2.models.response.getCalculation.allowancesAndDeductions.detail.{AllowancesAndDeductions, AnnualPayments, PensionContributionReliefs, PensionContributions, Reliefs, ReliefsClaimed, CalculationDetail => ADRCalculationDetail}
...
import v1r2.models.response.getCalculation.incomeTaxAndNics.summary.{CalculationSummary, IncomeTaxSummary}
import v1r2.models.response.getCalculation.taxableIncome._
import v1r2.models.response.getCalculation.taxableIncome.detail.PayPensionsProfit

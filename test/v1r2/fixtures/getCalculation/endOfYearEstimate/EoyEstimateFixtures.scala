...
package v1r2.fixtures.getCalculation.endOfYearEstimate

import play.api.libs.json.{ JsObject, JsValue, Json }
import v1r2.fixtures.getCalculation.endOfYearEstimate.detail.EoyEstimateDetailFixtures._
import v1r2.fixtures.getCalculation.endOfYearEstimate.summary.EoyEstimateSummaryFixtures._
import v1r2.models.response.getCalculation.endOfYearEstimate.EoyEstimate

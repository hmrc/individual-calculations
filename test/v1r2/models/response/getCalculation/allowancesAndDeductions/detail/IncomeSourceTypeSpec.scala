...
import v1r2.models.response.getCalculation.allowancesAndDeductions.detail.IncomeSourceType.{dividendsFromForeignCompanies, fhlPropertyEea, foreignIncome, foreignInterest, foreignProperty}

...
class GetCalculationControllerV1R2Spec
  ...
  trait Test {
    ...
    val controller = new GetCalculationV1R2Controller(
  ...
  val getCalculationResponse = GetCalculationResponseV1R2(metadata)

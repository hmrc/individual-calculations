...
package v2.fixtures.getCalculation

import play.api.libs.json.{JsObject, JsValue, Json}
import v2.fixtures.getCalculation.endOfYearEstimate.EoyEstimateFixtures.eoyEstimateResponse
import v2.models.domain.{CalculationReason, CalculationRequestor, CalculationType}
import v2.models.response.common.{Message, Messages, Metadata}
import v2.models.response.getCalculation.GetCalculationResponse
import v2.models.response.getCalculation.allowancesAndDeductions.AllowancesDeductionsAndReliefs
import v2.models.response.getCalculation.allowancesAndDeductions.detail.{AllowancesAndDeductions, AnnualPayments, PensionContributionReliefs, PensionContributions, Reliefs, ReliefsClaimed, CalculationDetail => ADRCalculationDetail}
import v2.models.response.getCalculation.allowancesAndDeductions.summary.{CalculationSummary => ADRCalculationSummary}
import v2.models.response.getCalculation.incomeTaxAndNics.IncomeTax
import v2.models.response.getCalculation.incomeTaxAndNics.detail.{CalculationDetail, IncomeTaxDetail, IncomeTypeBreakdown}
import v2.models.response.getCalculation.incomeTaxAndNics.summary.{CalculationSummary, IncomeTaxSummary}
...
object GetCalculationResponseFixtures {
  ...
  val calculationSummary: CalculationSummary = CalculationSummary(
    IncomeTaxSummary(100.25, None, None, None, None, None, None, None, None, None, None), None, None, None, None, None, None, 200.25, "UK")
  ...
  val incomeTax: IncomeTax = IncomeTax(calculationSummary, calculationDetail)
  ...
  val taxableIncomeModel: TaxableIncome = TaxableIncome(
    ...
    TaxableIncomeDetail(
      payPensionsProfit = Some(PayPensionsProfit(
        ...
        totalSeafarersDeduction = None,
        totalForeignTaxOnForeignEmployment = None,
        totalEmploymentIncome = None,
        totalShareSchemesIncome = None,
        totalOverseasPensionsStateBenefitsRoyalties = None,
  ...
  val calculationResponse: GetCalculationResponse = GetCalculationResponse(metadata.copy(totalIncomeTaxAndNicsDue = None), messages = Some(messages))

  val allowancesDeductionsAndReliefs: AllowancesDeductionsAndReliefs = AllowancesDeductionsAndReliefs(
  ...
  val calculationResponseAllParts: GetCalculationResponse = GetCalculationResponse(

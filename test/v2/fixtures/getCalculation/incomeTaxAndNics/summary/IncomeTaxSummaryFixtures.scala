...
package v2.fixtures.getCalculation.incomeTaxAndNics.summary

import play.api.libs.json.{JsValue, Json}
import v2.models.response.getCalculation.incomeTaxAndNics.summary.IncomeTaxSummary
...
object IncomeTaxSummaryFixtures {
  ...
  val incomeTaxSummaryJson: JsValue = Json.parse(
    """
      ...
      |   "totalTaxDeductedBeforeCodingOut": 1023.87,
      |   "saUnderpaymentsCodedOut": 1120.14
      |}
    """.stripMargin)

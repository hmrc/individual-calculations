...
import v2.models.response.getCalculation.incomeTaxAndNics.detail.{Class4Losses, Class4NicDetail, NicBand}
...
object Class4NicDetailFixtures {
  ...
  val class4NicDetailModel: Class4NicDetail = Class4NicDetail(

...
import v2.services.GetCalculationService

import scala.concurrent.{ExecutionContext, Future}

trait MockGetCalculationService extends MockFactory {

  val mockGetCalculationService: GetCalculationService = mock[GetCalculationService]

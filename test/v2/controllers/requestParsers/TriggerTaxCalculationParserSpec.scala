...
import v2.mocks.validators.MockTriggerTaxCalculationValidator
    ...
    "return an ErrorWrapper" when {
      ...
      "multiple validation errors occur" in new Test {
        ...
        parser.parseRequest(badInputData) shouldBe
          Left(ErrorWrapper(correlationId, BadRequestError, Some(Seq(NinoFormatError, RuleIncorrectOrEmptyBodyError))))
      }
    }
  }
}
